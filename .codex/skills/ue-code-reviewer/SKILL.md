...
Do not edit shared memory or instruction files during execution. If you discover a durable review rule, recurring violation pattern, or missing project convention, return it in a `Reusable Learnings` section instead.
